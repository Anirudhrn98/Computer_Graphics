...
function setUpPhong(program) {
  ...
  gl.uniform3fv(ambientLight, [1.0, 1.0, 1.0]);
  ...
  gl.uniform3fv(baseColor, [10.0, 0.0, 0.0])
  
  var specHighlightColor = gl.getUniformLocation(program, 'specHighlightColor')
  gl.uniform3fv(specHighlightColor, [0.0, 0.0, 0.0])
...
function createShapes() {
  ...
  // per fragment
  mySpherePerFragment = new Sphere (100,100);
